...
const Footer = () => {
  return (
    <>
      <footer className="text-center bg-[#020017] dark:bg-gray-900">
        <div className=" px-6 py-8 mx-auto items-center">
          <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
            <div>
              <div className="text-xl font-medium text-white">Features</div>
            ...
            <div>
              <div className="text-xl font-medium text-white">Company</div>
            ...
            <h1 href="#" className="flex items-center mt-5 text-sm font-medium text-gray-500 duration-700 dark:text-gray-300 hover:text-gray-400 dark:hover:text-gray-200 hover:underline">
      ...
      <div className="bg-[#020017]  pt-4 sm:pt-10 lg:pt-12">
        <footer className="mx-auto max-w-screen-2xl px-4 md:px-8">
          <div className="flex flex-col items-center pt-6">
            <div className="flex gap-4">
              <h1
                target="_blank"
                className="text-white transition duration-100 hover:text-white active:text-white"
              >
                <svg
                  className="h-5 w-5"
                  width="24"
